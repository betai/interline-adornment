...
namespace SanityTest
{
    internal static class MappingHelper
    {
        ...
        {
            List<SnapshotSpan> mappedSpans = new List<SnapshotSpan>();
        ...
        private static void SplitMapDownToFirstMatchNoTrack(List<SnapshotSpan> unmappedSpans, Predicate<ITextBuffer> match, IList<SnapshotSpan> mappedSpans, bool mapByContentType)
        {
